...
public class IndexModel : PageModel
{
    ...
    // The rest serve only the phone view (Board 00 - Mobile).

    /// <summary>The two non-pinned apps the Board 00 - Mobile view surfaces; the rest sit behind "See all".</summary>
