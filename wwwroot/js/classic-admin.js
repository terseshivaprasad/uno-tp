...
(function () {
  ...
  // Typing rolls on to the next box, as it does on every classic wizard step.
  Array.prototype.slice.call(document.querySelectorAll('[data-date], [data-time]')).forEach(function (box) {
